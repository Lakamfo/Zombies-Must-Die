...
func _ready() -> void:
	if ProjectSettings.get_setting("input_devices/pointing/emulate_mouse_from_touch"):
		DebugOutput.print_warning("The Project Setting 'emulate_mouse_from_touch' should be set to False")
	if not ProjectSettings.get_setting("input_devices/pointing/emulate_touch_from_mouse"):
		DebugOutput.print_warning("The Project Setting 'emulate_touch_from_mouse' should be set to True")
